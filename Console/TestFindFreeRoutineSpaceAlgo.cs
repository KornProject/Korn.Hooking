using Region = Korn.Hooking.Algorithms.BlockPlacementCollection.Region<Korn.Hooking.Algorithms.BlockPlacementCollection.Block>;
using Block = Korn.Hooking.Algorithms.BlockPlacementCollection.Block;
